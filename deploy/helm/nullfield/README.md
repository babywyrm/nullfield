...
| Path | Description |
|---|---|
| `files/camazotz/policy.yaml` | 57-tool tiered policy (ALLOW safe, ALLOW write, DENY dangerous, DENY *) |
| `files/camazotz/tools.yaml` | 57-tool registry for the camazotz MCP server |
